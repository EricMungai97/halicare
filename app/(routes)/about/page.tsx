...
const About = () => {
  ...
  return (
    <div className="p-8 bg-gray-100 flex flex-col items-start">
      ...
      <motion.div initial="initial" animate="animate" variants={textVariants} className="flex flex-wrap w-full">
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            ...
            <FaShieldAlt size={50} className="text-3xl m-auto text-sky-900" />
                <h3>Reliability</h3>
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className="border rounded-xl p-4 bg-white">
            <FaSmile size={50} className="text-3xl m-auto text-sky-900 "/>
                <h3>Compassion</h3>
       ...
       <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className='border rounded-xl p-4 bg-white'>
            <FaClock size={50} className="text-3xl m-auto text-sky-900 "/>
                <h3>Flexibility</h3>
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className='border rounded-xl p-4 bg-white'>
                <FaCheck size={50} className="text-3xl m-auto text-sky-900 "/>
                <h3>Commitment</h3>
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className="border rounded-xl p-4 bg-white">
            <FaGlobeAmericas size={50} className="text-3xl m-auto text-sky-900 "/>
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className="border rounded-xl p-4 bg-white">
            <FaUserFriends size={50} className="text-3xl m-auto text-sky-900 "/>
            <h3>Respect</h3>
        ...
        <div className="p-4 w-full sm:w-1/2 md:w-1/3">
            <div className="border rounded-xl p-4 bg-white">
            <FaThumbsUp size={50} className="text-3xl m-auto text-sky-900 "/>
